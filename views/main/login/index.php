...
<body>
    <section class="wrapper" style="background-image: url(/assets/images/uniqlo.jpeg); background-size: cover;
        ...
        <div class="box">
            ...
            height: auto;">
                    ...
                    <p style="text-align:center;">Bạn chưa có tài khoản? 
                        <a class = "dangky" href="index.php?page=main&controller=register&action=index">Đăng ký</a></p>
                </div>
            </form>
        </div>
    </section>
    <div class="fixed-bottom-right p-2">
        <div class="rounded p-2">
            <a href="index.php?page=main&controller=layouts&action=index"
                class="btn btn-dark btn-back-home d-flex align-items-center">
