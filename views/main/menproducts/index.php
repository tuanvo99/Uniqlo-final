...
<main>
    ...
    <div class="container-fluid py-2" style="margin-top: 86px; background-color: rgb(230,230,230,0.8)">
        <div class="container">
            ...
            <a href="index.php?page=main&controller=menproducts&action=index" class=" fw-bold me-2">&nbsp;&nbsp;Men</a>
        </div>
    </div>
    ...
    <div class="container-fluid py-2" style="margin-top: 10px">
        <div class="container-fluid px-4 px-lg-6 mt-4">
            ...
            foreach ($menproducts as $menproduct) {
                ...
                if ($menproduct->sale) {
                    echo '<div class="badge bg-dark text-light position-absolute" style="top: 0.5rem; right: 0.5rem; z-index: 10"> - ' . $menproduct->sale . '%</div>';
                }
                ...
                if ($menproduct->vote_number == 0) {
                    ...
                    echo '<p class="product-name text-muted" style="font-size: 1em">' . $menproduct->vote_number . ' lượt đánh giá</p>
                          <p class="product-name text-muted" style="font-size: 1em">' . $menproduct->total_stars / $menproduct->vote_number . ' &#9733</p>';
                }
    ...
    function sortProducts() {
        ...
        if (selectedValue === "highToLow") {
            window.location.href = 'index.php?page=main&controller=menproducts&action=sortByPriceHighToLow';
        } else if (selectedValue === "lowToHigh") {
            window.location.href = 'index.php?page=main&controller=menproducts&action=sortByPriceLowToHigh';
        }
