                        ...
                        <div class="modal fade" id="addUserModal" aria-labelledby="addUserModal" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form id="form-add-product" action="index.php?page=admin&controller=womenproducts&action=add" enctype="multipart/form-data" method="post">
                            ...
                            <div class="modal fade" id="EditProductModal" tabindex="-1" role="dialog" aria-labelledby="EditproductModal" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form id="form-edit-product" action="index.php?page=admin&controller=womenproducts&action=edit" enctype="multipart/form-data" method="post">
                                            <div class="modal-body">
