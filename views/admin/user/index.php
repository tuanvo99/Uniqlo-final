                ...
                <div class="col-12">
                    <div class="shadow p-2 rounded">
                        <div class="">
                            ...
                            <button class="btn btn-primary mb-2" type="button" data-bs-toggle="modal" data-bs-target="#addUserModal">+<i class="fas fa-user"></i></button>
                            <!-- Modal-->
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form action="index.php?page=admin&controller=user&action=delete" method="post">
                                            ...
                                            <div class="modal-footer">
                                                <button class="btn btn-primary btn-outline-light" type="button" data-bs-dismiss="modal">Hủy</button>
